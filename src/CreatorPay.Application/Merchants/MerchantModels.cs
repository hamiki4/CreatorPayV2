...
public sealed record RegisterMerchantRequest(string? LegalBusinessName, string TradingName, string BusinessType, string? TaxRegistrationNumber, string PhoneNumber, string? Email, string Password, string BusinessAddress, string City, string Region, string Country, string TimeZone, IReadOnlyList<MerchantDocumentMetadata>? Documents, string? PrimaryContactName = null, string? BusinessRegistrationNumber = null, string PreferredLanguage = "en", bool TermsAccepted = false, DateOnly? BirthDate = null, string? Confirmation = null);
