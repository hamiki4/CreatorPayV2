...
public sealed class PasswordOptions { public const string SectionName = "Authentication:Password"; public int MinimumLength { get; set; } = 10; public int MaximumLength { get; set; } = 128; public bool RequireUppercase { get; set; } = true; public bool RequireLowercase { get; set; } = true; public bool RequireDigit { get; set; } = true; public bool RequireNonAlphanumeric { get; set; } = true; }
