...
public enum CreatorBalanceEntryType { EarningPendingCredit, PendingToAvailable, AvailableToHold, HoldToAvailable, AvailableToScheduled, ScheduledToAvailable, ScheduledToPaid, EarningReversal, RecoveryCreated, ManualAdjustment }
