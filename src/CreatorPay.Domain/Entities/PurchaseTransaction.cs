...
public sealed class PurchaseTransaction : Entity
{
    ...
    public Guid? CustomerPhoneReferenceId { get; set; } public string? CustomerPhoneHash { get; set; } public DateOnly? MerchantLocalDate { get; set; } public Guid? RepeatUseApprovalRequestId { get; set; } public bool WasRepeatUseApproved { get; set; } public Guid? CustomerConfirmationId { get; set; }
