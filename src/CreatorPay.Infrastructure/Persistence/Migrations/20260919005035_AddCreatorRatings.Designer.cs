...
namespace CreatorPay.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919005035_AddCreatorRatings")]
    partial class AddCreatorRatings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.BusinessTypeWalletMinimumVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CurrencyCode", "BusinessType", "EffectiveFromUtc")
                        .IsUnique();

                    b.HasIndex("CurrencyCode", "BusinessType", "VersionNumber")
                        .IsUnique()
                        .HasDatabaseName("IX_business_type_wallet_minimum_versions_CurrencyCode_Busines~1");

                    b.ToTable("business_type_wallet_minimum_versions", (string)null);
                });
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.Creator", b =>
                {
                    ...
                    b.Property<string>("GovernmentIdReference")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("PreferredPayoutAccountIdentifier")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("PreferredPayoutChannel")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.CreatorRating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MerchantCreatorPartnershipId")
                        .IsUnique()
                    ...
                    b.HasIndex("CreatorId", "Rating")
                        .HasDatabaseName("IX_creator_ratings_creator_rating");

                    b.ToTable("creator_ratings", null, t =>
                        {
                            t.HasCheckConstraint("CK_creator_ratings_rating", "\"Rating\" >= 1 AND \"Rating\" <= 5");
                        });
                });
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.CreatorSocialProfile", b =>
                {
                    ...
                    b.HasIndex("CreatorId", "Platform", "Handle")
                        .IsUnique();

                    b.ToTable("creator_social_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.ExternalApplicationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ExternalProfileLinkId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ExternalProfileLinkId");

                    b.HasIndex("ExternalIdentityId", "ExpiresAtUtc");

                    b.HasIndex("UserAccountId", "RevokedAtUtc");

                    b.ToTable("external_application_sessions", (string)null);
                });

            modelBuilder.Entity("CreatorPay.Domain.Entities.ExternalIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IdentityBindingId", "IdentityBindingVersion");

                    b.HasIndex("Issuer", "Environment", "ExternalUserId")
                        .IsUnique();

                    b.ToTable("external_identities", (string)null);
                });

            modelBuilder.Entity("CreatorPay.Domain.Entities.ExternalProfileLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ExternalBusinessId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ExternalIdentityId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("ExternalProfileSubjectId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ExternalIdentityId", "Role")
                        .IsUnique()
                        .HasFilter("\"Role\" <> 'MerchantAdmin'");

                    b.HasIndex("ExternalIdentityId", "Role", "ExternalProfileSubjectId")
                        .IsUnique();

                    b.HasIndex("ExternalIdentityId", "Role", "Status")
                        .IsUnique()
                        .HasFilter("\"ExternalProfileSubjectId\" IS NULL");

                    b.ToTable("external_profile_links", (string)null);
                });
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.MerchantLocation", b =>
                {
                    ...
                    b.ToTable("merchant_locations", null, t =>
                        {
                            t.HasCheckConstraint("CK_merchant_locations_latitude", "\"Latitude\" IS NULL OR (\"Latitude\" >= -90 AND \"Latitude\" <= 90)");

                            t.HasCheckConstraint("CK_merchant_locations_longitude", "\"Longitude\" IS NULL OR (\"Longitude\" >= -180 AND \"Longitude\" <= 180)");
                        });
                });
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.PromotionVideo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("promotion_videos", (string)null);
                });
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.SupportRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<bool>("ConsentAcknowledged")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.ExternalApplicationSession", b =>
                {
                    b.HasOne("CreatorPay.Domain.Entities.ExternalIdentity", null)
                        .WithMany()
                        .HasForeignKey("ExternalIdentityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CreatorPay.Domain.Entities.ExternalProfileLink", null)
                        .WithMany()
                        .HasForeignKey("ExternalProfileLinkId")
                        .OnDelete(DeleteBehavior.Restrict);
