...
namespace CreatorPay.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260803215927_AddCreatorEarningsAndPayoutPreparation")]
    partial class AddCreatorEarningsAndPayoutPreparation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CreatorPay.Domain.Entities.PurchaseTransaction", b =>
                {
                    ...
                    b.HasIndex("CreatorId", "TransactionDateUtc");

                    b.HasIndex("MerchantId", "IdempotencyKey")
                        .IsUnique();

                    b.HasIndex("MerchantId", "TransactionDateUtc");
