...
const faqs = [
  ...
  ['Customers', 'What do I provide at checkout?', 'Give the Cashier the four-digit Creator ID shown on the promotion. The Cashier enters the Creator ID, your phone number when required, and the purchase amount using the Weymela checkout flow.'],
  ['Cashiers and Supervisors', 'How do I record a new purchase?', 'Enter the four-digit Creator ID, the Customer phone number when required, and the purchase amount. Review the details before submitting.'],
