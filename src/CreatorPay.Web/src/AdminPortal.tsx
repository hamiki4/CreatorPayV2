...
const routes=[['dashboard','Dashboard'],['reports','Reports'],['creators','Creators','pendingCreatorApprovals'],['merchants','Businesses','pendingMerchantApprovals'],['accounts','Accounts'],['commission','Commission'],['deposits','Deposits','pendingDeposits'],['wallets','Wallets'],['payouts','Payouts','pendingPayouts'],['fraud','Fraud','openFraudAlerts'],['system','System']]
