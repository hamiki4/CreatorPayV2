...
test('admin operations exposes the simplified secure pilot navigation',async()=>{
  ...
  for(const label of ['Cycle Start','Cutoff','Payout Date','Eligible/Scheduled Total','Reserved/In Batch','Paid This Cycle','Creator Name','Creator ID','Eligible Amount','Shopper Name','Eligible Cashback','Payout Status','UNPAID','Search Creator Name or Creator ID','Search Shopper Name','Clear','Period Start','Period End','Transactions','Platform Revenue','Platform Revenue History'])assert.match(payouts,new RegExp(label))
