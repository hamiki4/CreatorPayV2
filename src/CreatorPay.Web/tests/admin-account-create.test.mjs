...
test('platform admin accounts page exposes create account workflow',()=>{
  ...
  for(const label of ['Admin Accounts','Business Accounts','Creator Accounts','Customer Accounts','Cashier Accounts','Login Access','Remove Account']) assert.match(admin,new RegExp(label))
})
