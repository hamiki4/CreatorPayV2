...
6. Approval creates an active `MerchantCreatorPartnership`; this partnership is required for promotion.
7. Only an approved creator with an active partnership can generate commission transactions for that merchant.
