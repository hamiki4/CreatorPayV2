...
if (-not $env:ConnectionStrings__CreatorPay) { throw "ConnectionStrings__CreatorPay is required." }
...
psql $env:ConnectionStrings__CreatorPay -v ON_ERROR_STOP=1 -f $seedFile
